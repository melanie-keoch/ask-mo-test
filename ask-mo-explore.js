    ...
    setup() {
      ...
      async function handleQuery(queryObj, type) {
        ...
        if (queryObj.response.tableData) {
          ...
          await wait(200); scrollToBottom();
          await wait(300); scrollToBottom();
        }
          ...
          <div class="grid md:grid-cols-3 gap-8 relative">
            ...
            <div class="relative z-10 text-center">
              ...
              <ul class="text-sm text-gray-400 space-y-2">
                <li class="flex items-center justify-center gap-2"><span class="w-1.5 h-1.5 bg-brand-purple rounded-full"></span>Plain language questions</li>
                <li class="flex items-center justify-center gap-2"><span class="w-1.5 h-1.5 bg-brand-purple rounded-full"></span>No reporting expertise needed</li>
                <li class="flex items-center justify-center gap-2"><span class="w-1.5 h-1.5 bg-brand-purple rounded-full"></span>Ask like you would a teammate</li>
              </ul>
            </div>
            ...
            <div class="relative z-10 text-center">
              ...
              <ul class="text-sm text-gray-400 space-y-2">
                <li class="flex items-center justify-center gap-2"><span class="w-1.5 h-1.5 bg-brand-violet rounded-full animate-pulse"></span>Results in seconds</li>
                <li class="flex items-center justify-center gap-2"><span class="w-1.5 h-1.5 bg-brand-violet rounded-full animate-pulse" style="animation-delay:0.3s"></span>Interactive visualizations</li>
                <li class="flex items-center justify-center gap-2"><span class="w-1.5 h-1.5 bg-brand-violet rounded-full animate-pulse" style="animation-delay:0.6s"></span>Written summaries included</li>
              </ul>
            </div>
            ...
            <div class="relative z-10 text-center">
              ...
              <ul class="text-sm text-gray-400 space-y-2">
                <li class="flex items-center justify-center gap-2"><span class="w-1.5 h-1.5 bg-emerald-400 rounded-full"></span>Filter and drill into charts</li>
                <li class="flex items-center justify-center gap-2"><span class="w-1.5 h-1.5 bg-emerald-400 rounded-full"></span>Download for presentations</li>
                <li class="flex items-center justify-center gap-2"><span class="w-1.5 h-1.5 bg-emerald-400 rounded-full"></span>Copy summaries for emails</li>
              </ul>
            </div>
          </div>
