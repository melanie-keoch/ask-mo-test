    ...
    const Hero = {
      ...
      template: `
        <section class="relative min-h-screen flex items-center justify-center overflow-hidden bg-brand-navy pt-16">
          ...
          <div class="relative z-10 max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <div class="flex gap-4 mt-8">
                ...
                <a href="#how-it-works" class="px-6 py-3 border border-white/20 text-white font-semibold rounded-[10px] hover:bg-white/10 transition-all">
                  How It Works
                </a>
              </div>
            </div>
            ...
            <div class="bg-white/5 backdrop-blur-xl rounded-2xl shadow-2xl shadow-black/20 border border-white/10 overflow-hidden max-w-md mx-auto w-full">
              ...
              <!-- Chat Body -->
              <div ref="chatBody" class="h-96 overflow-y-auto p-4 space-y-4 bg-transparent">
              ...
              <div class="border-t border-white/10 bg-white/5 px-4 py-3 flex items-center gap-2">
                ...
                <button disabled class="w-9 h-9 bg-brand-yellow rounded-full flex items-center justify-center opacity-50">
              ...
              <div class="bg-red-500/10 border border-red-500/20 rounded-2xl p-8">
                ...
                <div class="space-y-4">
                  <div class="bg-black/20 rounded-lg p-4 border border-red-500/10">
                    <div class="font-mono text-xs text-red-300 bg-black/30 p-3 rounded mb-2">
        ...
        <section id="interactive-demo" class="py-24 bg-brand-navy border-t border-white/5">
          <div class="max-w-5xl mx-auto px-6">
            ...
            <div class="bg-white/5 backdrop-blur-xl rounded-2xl shadow-2xl shadow-black/20 border border-white/10 overflow-hidden">
              ...
              <div ref="chatBody" class="h-[28rem] overflow-y-auto p-5 space-y-4 bg-transparent">
          ...
          <div class="max-w-6xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-8 relative">
              <svg class="hidden md:block absolute top-16 left-0 w-full h-4 z-0" preserveAspectRatio="none">
                <line x1="20%" y1="8" x2="48%" y2="8" stroke="rgba(255,255,255,0.15)" stroke-width="2" class="dashed-line"/>
                <line x1="52%" y1="8" x2="80%" y2="8" stroke="rgba(255,255,255,0.15)" stroke-width="2" class="dashed-line"/>
              </svg>
    ...
    const App = {
      ...
      template: `
        <div>
          <!-- Navigation -->
          <nav class="fixed top-0 left-0 right-0 z-50 bg-brand-navy/80 backdrop-blur-xl border-b border-white/5">
            <div class="max-w-7xl mx-auto px-6 flex items-center justify-between h-16">
              <!-- Logo -->
              <a href="https://gomomentus.com" class="flex items-center">
                <img src="momentus-logo.svg" alt="Momentus" style="height: 2.3rem;" />
              </a>

              <!-- Desktop Nav -->
              <div class="hidden lg:flex items-center gap-8">
                <div class="flex items-center gap-6 text-sm">
                  <a href="https://gomomentus.com/enterprise-event-management-software" class="text-gray-300 hover:text-white transition-colors">Products</a>
                  <a href="https://gomomentus.com/ask-mo" class="text-white font-medium">Ask Mo</a>
                  <a href="https://gomomentus.com/customer-stories" class="text-gray-300 hover:text-white transition-colors">Customers</a>
                  <a href="https://gomomentus.com/content-hub" class="text-gray-300 hover:text-white transition-colors">Resources</a>
                  <a href="https://gomomentus.com/about-us" class="text-gray-300 hover:text-white transition-colors">Company</a>
                </div>
                <a href="https://gomomentus.com/request-demo" class="px-5 py-2 bg-brand-yellow text-brand-navy font-bold text-sm rounded-[10px] hover:shadow-lg hover:shadow-yellow-500/25 transition-all hover:-translate-y-0.5">
                  Book Demo
                </a>
              </div>
            ...
            <!-- Mobile Menu -->
            <div v-if="mobileMenuOpen" class="lg:hidden bg-brand-navy/95 backdrop-blur-xl border-t border-white/5 px-6 py-4 space-y-3">
              <a href="https://gomomentus.com/enterprise-event-management-software" class="block text-gray-300 hover:text-white text-sm py-2">Products</a>
              <a href="https://gomomentus.com/ask-mo" class="block text-white font-medium text-sm py-2">Ask Mo</a>
              <a href="https://gomomentus.com/customer-stories" class="block text-gray-300 hover:text-white text-sm py-2">Customers</a>
              <a href="https://gomomentus.com/content-hub" class="block text-gray-300 hover:text-white text-sm py-2">Resources</a>
              <a href="https://gomomentus.com/about-us" class="block text-gray-300 hover:text-white text-sm py-2">Company</a>
              <a href="https://gomomentus.com/request-demo" class="block mt-2 px-5 py-2.5 bg-brand-yellow text-brand-navy font-bold text-sm rounded-[10px] text-center">Book Demo</a>
            </div>
          </nav>
          ...
          <!-- Footer -->
          <footer class="bg-brand-navy border-t border-white/5 text-gray-400 py-12">
            <div class="max-w-6xl mx-auto px-6 text-center">
              <a href="https://gomomentus.com" class="inline-flex items-center justify-center mb-4">
                <img src="momentus-logo.svg" alt="Momentus" class="h-5 opacity-60" />
              </a>
              <p class="text-sm mb-6">AI-powered self-serve reporting for venue and event management.</p>
              <p class="text-xs text-gray-600">This is a demo experience. No real data or AI is being used.</p>
            </div>
          </footer>
        </div>
      `
